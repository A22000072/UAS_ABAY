...
if (isset($_GET['id'])) {
  ...
  $query = "SELECT * FROM mahasiswa,kelas,spp where mahasiswa.nim='$id' AND mahasiswa.id_kelas=kelas.id_kelas AND mahasiswa.id_spp=spp.id_spp";
              ...
              <div class="wizard-pane">
                ...
                <div class="form-group row align-items-center">
                  ...
                  <div class="col-lg-4 col-md-6">
                    <input name="nim" value="<?php echo $data['nim']; ?>" disabled="" />
                  </div>
                </div>
                <div class="form-group row align-items-center">
